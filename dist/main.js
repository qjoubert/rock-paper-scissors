...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _play__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./play */ \"./src/modules/play.js\");\n/* harmony import */ var _round__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./round */ \"./src/modules/round.js\");\n/* harmony import */ var _score__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./score */ \"./src/modules/score.js\");\n\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ((function () {\n  var playBtn = document.querySelector(\"#play-btn\");\n  var resetBtn = document.querySelector(\"#reset-btn\");\n  var infoDisplay = document.querySelector(\"#info-display\");\n\n  function _checkWinner() {\n    return _score__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getPlayerScore() == 3 || _score__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getComputerScore() == 3;\n  }\n\n  function _clearMoves() {\n    document.querySelector(\"#computer-move\").textContent = \"\";\n    document.querySelector(\"#player-move\").textContent = \"\";\n  }\n\n  function _getWinner() {\n    if (_score__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getPlayerScore() == 3) return \"player\";\n    if (_score__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getComputerScore() == 3) return \"evil\";\n    return null;\n  }\n\n  function _hide(btn) {\n    btn.style.display = \"none\";\n  }\n\n  function _show(btn) {\n    btn.style.display = \"inline-block\";\n  }\n\n  function _showInfo(text) {\n    infoDisplay.textContent = text;\n  }\n\n  function _showWinner(winner) {\n    infoDisplay.textContent = \"\\n     \".concat(winner, \" wins the game!\\n     Game Over\\n    \");\n  }\n\n  function onMoveClick(e) {\n    _play__WEBPACK_IMPORTED_MODULE_0__[\"default\"].playRound(e);\n\n    if (_checkWinner()) {\n      _showWinner(_getWinner());\n\n      _play__WEBPACK_IMPORTED_MODULE_0__[\"default\"].hideMoveBtns();\n\n      _hide(resetBtn);\n\n      _show(playBtn);\n    } else {\n      _round__WEBPACK_IMPORTED_MODULE_1__[\"default\"].setRound();\n      _round__WEBPACK_IMPORTED_MODULE_1__[\"default\"].showRound();\n    }\n  }\n\n  function resetGame(e) {\n    if (e.target.id === \"reset-btn\") {\n      _round__WEBPACK_IMPORTED_MODULE_1__[\"default\"].clearRound();\n      _play__WEBPACK_IMPORTED_MODULE_0__[\"default\"].hideMoveBtns();\n\n      _hide(resetBtn);\n\n      _show(playBtn);\n\n      _showInfo('click \"play\" to start a new game');\n    }\n\n    _clearMoves();\n\n    _score__WEBPACK_IMPORTED_MODULE_2__[\"default\"].clearScore();\n    _round__WEBPACK_IMPORTED_MODULE_1__[\"default\"].resetRound();\n    _score__WEBPACK_IMPORTED_MODULE_2__[\"default\"].resetScore();\n    _score__WEBPACK_IMPORTED_MODULE_2__[\"default\"].showScore();\n  }\n\n  function setNewGame() {\n    _hide(playBtn);\n\n    _show(resetBtn);\n\n    _play__WEBPACK_IMPORTED_MODULE_0__[\"default\"].showMoveBtns();\n    _round__WEBPACK_IMPORTED_MODULE_1__[\"default\"].showRound();\n\n    _showInfo(\"choose your move\");\n  }\n\n  return {\n    onMoveClick: onMoveClick,\n    resetGame: resetGame,\n    setNewGame: setNewGame\n  };\n})());\n\n//# sourceURL=webpack:///./src/modules/game.js?");
